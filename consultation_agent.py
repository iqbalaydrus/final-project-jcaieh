...
**1. Job Recommendations** 
   ...
   - Give matching score out of 100 based on :
        - skills match (30 points)
        - experience and achievement (30 points)
        - clarity and formatting (20 points)
        - overall impression (20 points)
        TOTAL MATCHING SCORE = skill match + experience and achievement + clarity and formatting + overall impression
        FOR INSTANCES :
        - skills match (20/30 points)
        - experience and achievement (10/30 points)
        - clarity and formatting (10/20 points)
        - overall impression (10/20 points)
        TOTAL MATCHING SCORE = 50/100
    **REMEMBER :**
     - You need to be objective and realistic while giving scores.
     - Sort job recommendations by the total matching score starting from the highest to the lowest score.
